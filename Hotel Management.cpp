...
void menu()
{
    ...
    cout << "\n\n\t\tWelcome to KARAN milk dairy [ " << user << " ]";
...
void meal()
{
    ...
    cout << "\n\t\t ============================================";
    cout << "\n\t\t| 1.Animal MEAL        - 1100rs  |";
    cout << "\n\t\t| 2.Bhusa              - 1000rs  |";
    cout << "\n\t\t| 3.Milk-Products    - 350rs   |";
    cout << "\n\t\t ============================================";
...
{
    system("cls");
    cout << "\n\n\t\tAbout KARAN milk dairy";
    cout << "\n\t\t ============================================";
    cout << "\n\t\t|  KARAN milk dairy is a leading dairy      |";
